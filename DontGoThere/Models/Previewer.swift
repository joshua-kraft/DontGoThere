...
struct Previewer {
  ...
  init() throws {
    ...
    neverExpiresPlace = Place(name: "Forever Place Name", notes: "Headline of what was bad", review: "A little bit longer text so that we can see what wrapping looks like in the multi-line text field when writing a particularly long or multi-lined review.\n\nMaybe there are two paragraphs. Who knows what people could write when they're upset.", latitude: 30.5052, longitude: -97.8203, addDate: Date.now, expirationDate: Date.distantFuture, imageData: [], shouldExpire: false)
